...
import com.america.web.rest.errors.BadRequestAlertException;
import java.net.URI;
...
/**
 * REST controller for managing {@link com.america.domain.Member}.
 */
@RestController
@RequestMapping("/api")
public class MemberResource {
    ...
    private static final String ENTITY_NAME = "americaMember";
