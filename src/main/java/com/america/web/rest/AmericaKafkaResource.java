...
@RestController
@RequestMapping("/api/america-kafka")
public class AmericaKafkaResource {

    private final Logger log = LoggerFactory.getLogger(AmericaKafkaResource.class);
    ...
    public AmericaKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
