...
import { IMember, defaultValue } from 'app/shared/model/america/member.model';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MEMBER_LIST actions', async () => {
    ...
    it('dispatches SEARCH_MEMBERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_MEMBER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_MEMBER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_MEMBER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_MEMBER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_MEMBER actions', async () => {
      const expectedActions = [
        {
